...
Create a structured ATC specification that documents everything needed to implement a single Acceptance Test Case: method signature, assertions split (fixed vs test-level), endpoint/page details, types, and an implementable code template.
