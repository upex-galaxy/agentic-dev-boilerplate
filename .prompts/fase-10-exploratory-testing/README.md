...
**Bug Fixing:** When bugs are reported, developers use `.prompts/fase-7-implementation/bug-fix.md` to implement fixes.
...
Decision: PASSED or FAILED?
    ...
    └── FAILED → Wait for fixes (DEV uses bug-fix.md), re-test
```
...
- **Bug Fixing (DEV):** `.prompts/fase-7-implementation/bug-fix.md`
