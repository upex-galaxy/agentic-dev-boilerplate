...
const DOC_META_ALLOWLIST: Array<[string, string]> = [
  ...
  // .agents/skills/REGISTRY.md is auto-generated by build-skill-registry.ts
  ...
  // Only bites when `bunx skills add` copies the skill into .agents/skills/
