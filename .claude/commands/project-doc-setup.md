---
description: Regenerate README.md and CLAUDE.md from current repo state and .agents/project.yaml
---
...
1. IDENTIFICAR TAREA
   └─ Feature, refactor, bugfix, etc.

2. CARGAR CONTEXTO
   └─ Leer guidelines DEV
   └─ Leer story/plan relevantes

3. EJECUTAR TAREA
   └─ Seguir principios de desarrollo
