...
>
> **Status (v1.3)**: community catalog expanded. 4 skills promoted user→project (`playwright-cli`, `n8n-skills`, `emil-design-eng`, `ui-ux-pro-max`), 3 frontend-ui project skills added (`impeccable`, `design-taste-frontend`, `redesign-existing-projects`), 1 user-level utility skill added (`html-ppt`). New §5.1 category: `presentation`. v1.2 wiring preserved.
>
> **Companion files**:
>
