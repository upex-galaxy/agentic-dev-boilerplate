...
| `references/testing-capabilities.md`   | `unit-testing`, `sprint-dev`                                                                                               | Cache schema + detection algorithm for `.context/_framework/testing-capabilities.json` (runner / e2e / typecheck / lint / strict_tdd). |
