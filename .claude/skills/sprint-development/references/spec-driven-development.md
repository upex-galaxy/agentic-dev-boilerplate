...
1. User story con acceptance criteria
2. Acceptance Test Plan (test cases detallados)
...
**Problema**: Sin tests, no hay confianza en refactorizar. Los test cases ya existen como parte del Acceptance Test Plan (de la fase de planning).
