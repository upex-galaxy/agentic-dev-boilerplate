...
**Shape**: `main` (production) + one integration branch (`staging` / `dev` / `develop`). Features merge to integration; integration promotes to `main` only on release. This is the "Apex Galaxy" / "agentic-dev-boilerplate" layout.
