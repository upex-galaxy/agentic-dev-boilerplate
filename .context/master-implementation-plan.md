...
- **Consumed by**: `/sprint-dev` (per-story planning grounds each ticket in this roadmap), `/product-management` (epic-creation pulls Wave-0 features here), and any human reading the dev roadmap.
