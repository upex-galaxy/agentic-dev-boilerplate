...
- **Test Strategy**: `.context/TAE/test-strategy.md`
- **Implementation Plan**: `.context/TAE/kata-implementation-plan.md`
- **Automation Standards**: `.context/TAE/automation-standards.md`
- **TMS Integration**: `.context/TAE/tms-integration.md`
- **CI/CD Integration**: `.context/TAE/ci-cd-integration.md`
